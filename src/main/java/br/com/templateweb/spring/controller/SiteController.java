...
public class SiteController {
    ...
    /**
     * Inicializa a index já realizando uma busca no banco de dados quando é
     * realizado a busca das informações de GALERIA e INSTITUCIONAL
     *
     * @return
     */
    ...
    public ModelAndView index() {
        ...
        for (Pagina pagina : paginas) {
            if (paginaService.salvarOuAtualizar(pagina)) {
                model.addObject("title", "Pagina Index, banco OK");
    ...
    @RequestMapping(value = {"/institucional"}, method = RequestMethod.GET)
